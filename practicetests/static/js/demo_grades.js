    ...
    $('.appending_div').on('click', '.remove', function() {
      ...
      $.ajax({
        ...
        success: function(response) {
          ...
          window.location.href = '/createtests/demo-view/';
        },
...
$(document).ready(function() {
  ...
  $(document).ready(function() {
    ...
    $('#quick-test-form').on('submit', function(e) {
      ...
      const userMembershipType = "Demo";
      const userMembershipWords = 2000;
      const userMembershipQuestions = 6;
      const userMembershipTests = 2;
      const userTestsCountLastMonth = 1;
